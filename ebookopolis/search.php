...
$search_mat = $_GET["str"];
$searc_sql = "SELECT * FROM books WHERE b_name LIKE '%{$search_mat}%'";
$res_search = mysqli_query($con,$searc_sql);
$total_rows = mysqli_num_rows($res_search);
                                ...
                                <div class="shop__grid__view__wrap">
                                    <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
                                        ...
                                        if($total_rows!=0){
                                          ...
                                          while($data = mysqli_fetch_assoc($res_search)){
                                          
                                        ?>
                                        <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                                            <div class="category">
                                                <div class="ht__cat__thumb">
                                                    <a href="product.php?pro_id=<?php echo $data['b_id']?>">
                                                        <img src="../admin/media/<?php echo $data['b_image']?>" alt="product images">
                                                    </a>
                                                </div>
                                               
                                                <div class="fr__product__inner">
                                                    <h4><a href="product.php?pro_id=<?php echo $data['b_id']?>"><?php echo $data['b_name']?></a></h4>
                                                    <ul class="fr__pro__prize">
                                                        <li class="old__prize" style="text-decoration:line-through;"><?php echo $data['b_mrp']?></li>
                                                        <li><?php echo $data['b_price']?></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
