                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_sql = "SELECT * FROM order_details INNER JOIN books ON order_details.book_id = books.b_id WHERE order_id = '{$order_id}'";
                                            ...
                                            ?>
                                            <tr>
                                                <td class="product-price"><?php echo $data['id']?></td>
                                                <td class="product-add-to-cart"><img src="../admin/media/<?php echo $data['b_image']?>" alt="" height="150" width="150"></td>
